...
```bash
cd /home/ec2-user/awsticket/experiments
...
for rate in 10 50 100; do
  ...
  cp exports/*.csv results/calibration/rate_${rate}/
...
for workers in 1 2 4 8; do
  ...
  cp exports/*.csv results/speedup/workers_${workers}/
...
cp exports/*.csv results/stress/max_rate_1000/
```
...
for run in 1 2; do
  ...
  cp exports/*.csv results/elasticity/run_${run}/
...
cp exports/*.csv results/contention/uniform/
...
cp exports/*.csv results/contention/hotspot_80_5/
```
...
scp -r ec2-user@10.0.1.70:/home/ec2-user/awsticket/experiments/results/ ./results/
...
# Generar plots
python3 plot_results.py --input-dir ../experiments/results --output-dir ./plots
```
